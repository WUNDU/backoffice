  ...
  return (
    <AdminLayout>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 flex items-center">
          ...
          <div>
            ...
            <p className="text-red-600 text-sm">
              ...
              <Link to="/admin/seguranca/alertas" className="ml-2 underline">Verificar</Link>
            </p>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-8 p-6">
        <h3 className="font-medium text-gray-800 mb-4">Estatísticas de Usuários Ativos</h3>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-8">
        <div className="p-6 border-b border-gray-100">
          <div className="flex justify-between items-center">
            <h3 className="font-medium text-gray-800">Distribuição Geográfica de Usuários</h3>
              ...
              <div key={index} className="flex items-center">
                ...
                <div className="flex-1">
                  <div className="relative h-4 w-full bg-gray-200 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${(region.users / kpiData.totalUsers) * 100}%` }}
                    ></div>
                  </div>
                </div>
                <div className="w-24 text-right text-sm font-medium text-gray-700">
                  ...
                  <span className="text-xs text-gray-500 ml-1">
                    ({((region.users / kpiData.totalUsers) * 100).toFixed(1)}%)
                  </span>
                </div>
              </div>
            ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 lg:col-span-2">
          <div className="p-6 border-b border-gray-100">
            <div className="flex justify-between items-center">
              <h3 className="font-medium text-gray-800">Transações Recentes</h3>
              <div className="flex space-x-2">
                <button className="p-1 text-gray-500 hover:text-gray-700">
                  <Filter size={16} />
                </button>
                <Link to="/admin/transacoes" className="flex items-center text-secondary text-sm">
                  Ver todas
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100">
          <div className="p-6 border-b border-gray-100">
            <div className="flex justify-between items-center">
              <h3 className="font-medium text-gray-800">Alertas de Segurança</h3>
              <Link to="/admin/seguranca/alertas" className="flex items-center text-secondary text-sm">
                Ver todos
                <ChevronRight size={16} className="ml-1" />
              </Link>
            </div>
          ...
          <div className="p-6">
            <div className="space-y-4">
              <div className="flex p-3 bg-red-50 rounded-lg">
